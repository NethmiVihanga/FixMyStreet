...
- **Photo Upload:** Attach photos of the issue directly from your camera or gallery to provide clear evidence.
- **Location Picker:** Precisely pin the location of the issue on an interactive map.
- **Issue Tracking:** View a feed of reported issues, track their resolution status, and view detailed information.
- **Community Engagement:** Discuss and comment on issues, and stay updated with real-time notifications.
...
1. Clone the repository:
   ```bash
   git clone https://github.com/NethmiVihanga/FixMyStreet.git
   ```
